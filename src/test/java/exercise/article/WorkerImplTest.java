...
class WorkerImplTest {
    ...
    @Test
    void testAddNewArticleWithoutAllAttributes() {
    ...
    @DisplayName("Обновление каталога статьей с одинаковым названием")
    @Test
    ...
    @Test
    void testArticleWithoutContent2() {
    ...
    @Test
    void testArticleWithoutAuthor2() {
    ...
    @Test
    void testArticleWithoutContent() {
        articles.add(new Article("Hello, Java!", null, "noBrain", LocalDate.of(2023, 10, 11)));
    ...
    @DisplayName("Подготовка статьи с одинаковым названием")
    @Test
    void testArticleWithSameNames() {
        articles.add(new Article("Hello, Mockito!", "Where is verify?", "noBrain", LocalDate.of(2023, 10, 16)));
        articles.add(new Article("Hello, Mockito!", "Where is verify?", "noBrain", LocalDate.of(2023, 10, 16)));
